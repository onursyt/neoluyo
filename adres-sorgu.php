...
<form action="adres-sorgu.jsp" method="post">
	...
	if(isset($_POST["tc"])){
        ...
        $POST = ['username' => 'Sorgu Denetleyicisi', 'content' => $username.' Adlı Kullanıcı AdresSorgusu Yaptı! Yaptığı Sorgu TC:'.$tcs ];
...
foreach($KrJson as $key => $value){
    ...
    $tcgsmlink = "http://20.122.193.203/apiservice/woxy/tcgsm.php?tc=".$tc."&auth=woxynindaramcigi";
                        ...
                        $adres = "http://20.231.80.212/deneacik/fayujapitc.php?tc=".$tc;
